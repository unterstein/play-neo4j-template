...
(function ($) {
  ...
  DateTimePicker.prototype = {
    ...
    fillDate: function () {
      ...
      var startYear = typeof startDate === 'object' ? startDate.getUTCFullYear() : -Infinity;
      var startMonth = typeof startDate === 'object' ? startDate.getUTCMonth() : -1;
      var endYear = typeof endDate === 'object' ? endDate.getUTCFullYear() : Infinity;
      var endMonth = typeof endDate === 'object' ? endDate.getUTCMonth() : 12;
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        if ((prevMonth.valueOf() + 86400000) <= startDate) {
          clsName += ' disabled';
        }
